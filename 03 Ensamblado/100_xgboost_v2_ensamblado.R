...
lista_datos <- readRDS('lista_subir_final_ensamble.rds')
...
nombres_col <- c('xgb_2_1_ensamble', 'xgb_2_2_ensamble', 
                 'xgb_2_3_ensamble', 'xgb_2_4_ensamble')
...
write.csv(predict_fase_1,'xgb_2_ensamble_fase_1_20170802.csv',row.names = F)

setwd('C:/Users/Cesar Quezada/Dropbox/KAGGLE/01. Concurso 01/02_segunda_fase')
write.csv(data_subir,'xgb_2_ensamble_fase_2_20170802.csv',row.names = F)
