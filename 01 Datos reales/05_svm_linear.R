...
num_simula <- 5
nombres_col <- c('svm_1', 'svm_2', 'svm_3', 'svm_4')
...
write.csv(predict_fase_1,'svm_fase_1_20170727.csv',row.names = F)

setwd('C:/Users/Cesar Quezada/Dropbox/KAGGLE/01. Concurso 01/02_segunda_fase')
write.csv(data_subir,'svm_fase_2_20170727.csv',row.names = F)
