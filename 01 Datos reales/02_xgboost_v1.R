...
nombres_col <- c('xgb_1_1', 'xgb_1_2', 'xgb_1_3', 'xgb_1_4')
...
write.csv(predict_fase_1,'xgb_1_fase_1_20170728.csv',row.names = F)

setwd('C:/Users/Cesar Quezada/Dropbox/KAGGLE/01. Concurso 01/02_segunda_fase')
write.csv(data_subir,'xgb_1_fase_2_20170728.csv',row.names = F)
