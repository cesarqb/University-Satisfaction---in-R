...
num_simula <- 5
nombres_col <- c('glmnet_1_1', 'glmnet_2_1', 'glmnet_3_1', 'glmnet_4_1')
...
write.csv(predict_fase_1,'glmnet_2_fase_1_20170802.csv',row.names = F)

setwd('C:/Users/Cesar Quezada/Dropbox/KAGGLE/01. Concurso 01/02_segunda_fase')
write.csv(data_subir,'glmnet_2_fase_2_20170802.csv',row.names = F)
